...
static inline m256 mm_set_ps(float e7, float e6, float e5, float e4, float e3,
...
static void compute_v2(unsigned char *img, float xmin, float xmax, float ymin,
                       float ymax) {
  ...
  m256 cx_start_delta =
      mm_set_ps(step_x * 7.0f, step_x * 6.0f, step_x * 5.0f, step_x * 4.0f,
